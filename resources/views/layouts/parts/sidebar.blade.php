        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <!-- @can('answer-list')<li class="nav-item">
                <a href="{{ url('answers-list') }}"
                    class="nav-link {{request()->is('answers-list') ? 'active' : ''}}">
                    <i class="nav-icon icon-xs me-2 fa fa-book-open"></i> 
                    {{__('Check Answer')}}
                </a>
            </li>@endcan -->
            ...
            @can('question-list')<li class="nav-item">
                <a href="{{ url('questions') }}" class="nav-link {{request()->is('questions') ? 'active' : ''}}">
                    <i class="nav-icon icon-xs me-2 fa fa-question"></i> 
                    {{__('Questions')}}
                </a>
            </li>@endcan
            @can('exam-list')<li class="nav-item">
                <a href="{{ url('exams') }}" class="nav-link {{request()->is('exams') ? 'active' : ''}}">
                    <i class="nav-icon icon-xs me-2 fa fa-file"></i>
                        {{__('Exams')}}
                </a>
            </li>@endcan
            @can('course-list')<li class="nav-item">
                <a href="{{ url('courses') }}" class="nav-link {{request()->is('courses') ? 'active' : ''}}">
                    <i class="nav-icon icon-xs me-2 fa fa-graduation-cap"></i> {{__('Courses')}}</a>
            </li>@endcan
            <!-- @can('student-list')<li class="nav-item">
                <a href="{{ url('students') }}" class="nav-link {{request()->is('students') ? 'active' : ''}}"><i
                        class="nav-icon icon-xs me-2 fa fa-user"></i> {{__('Students')}}</a>
            </li>@endcan -->
