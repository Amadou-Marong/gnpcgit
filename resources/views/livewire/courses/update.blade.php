<!-- Modal -->
<div wire:ignore.self class="modal fade" id="courseUpdateModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="courseUpdateModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group mt-3">
                ...
                <input wire:model="course_unique_id" type="text" class="form-control" id="course_unique_id" placeholder="{{__('Course Unique Id')}}">@error('course_unique_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
